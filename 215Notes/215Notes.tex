...
\thm{Formula to determine validity}{
  \begin{enumerate}
    ...
    \item If there are no critical rows, then the argument is \textbf{vacuously true}.
  \end{enumerate}
}
...
\dfn{Modus Ponens}{
  If $P \implies Q$ and $P$ are true, then $Q$ is true. It is a method of affirming.
...
\ex{Modus Ponens}{
  \begin{itemize}
    \item If the sum of the digits of 371487 is divisible by 3, then 371487 is divisible by 3. 
    \item The sum of the digits of 371487 is divisible by 3. 
    \item $ \therefore $ 371487 is divisible by 3.
  \end{itemize}
}

\dfn{Modus Tollens}{
  If $P \implies Q$ and $\lnot Q$ are true, then $\lnot P$ is true. It is a method of denying.
...
\nt{
  ...
  \begin{itemize}
    \item Modus ponens is valid and the fact that a conditional statement is logically equivalent to its contrapositive. Or 
    \item It can be established formally using a truth table.
  \end{itemize}
}

\ex{Modus Tollens}{
  \begin{itemize}
    \item If Zeus is human, then Zeus is mortal. 
    \item Zeus is not mortal. 
    \item $ \therefore $ Zeus is not human.
  \end{itemize}
}
...
\dfn{Generalization}{
  ...
  EX: Anton is a junior. Therefore, Anton is a junior or Anton is a senior.
}
...
\dfn{Specialization}{
  ...
  EX: If it is raining and the sun is shining, then it is raining.
}
...
\dfn{Elimination}{
  ...
  EX: If it is raining or the sun is shining, and it is not raining, then the sun is shining
}
...
\dfn{Transitivity}{
  ...
  EX: If it is raining, then the sun is shining. If the sun is shining, then the grass is wet. Therefore, if it is raining, then the grass is wet.
}
...
\dfn{Proof by contradiction}{
  To prove a proposition $P$, assume that $\lnot P$ is true and show that this assumption leads to a contradiction.
}
