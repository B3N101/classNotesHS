...
\qs{Find the magnetic field of a concentric wire}{
  $$ A_{\text{enc}} = \pi b^2 - \pi a^2 $$
  $$ A = \pi r^2 - \pi a^2 $$
  $$ j = \frac{I}{A_{\text{enc}}} $$ 
  $$ I_{\text{enclosed}} = jA = \frac{I}{\pi b^2 - \pi a^2} (\pi r^2 - \pi a^2) = I $$
  $$ B_{0\to a} = 0 $$ 
  $$ B_{a\to b} = \frac{\mu_0}{2\pi r} I\left(\pi \frac{r^2 - a^2}{b^2 - a^2}\right) $$
  $$ B_{b\to r} = \frac{\mu_0 I}{2\pi r} $$
